        ...
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <div className="bg-primary/10 dark:bg-primary/20 rounded-xl p-8 md:p-12 text-center space-y-4 border-2 border-primary/20">
            ...
            <p className="text-lg md:text-xl text-primary-foreground/90 max-w-4xl mx-auto dark:text-gray-200">
              Chọn một khóa học dưới đây. Mỗi lộ trình được thiết kế chi tiết với lý thuyết, ví dụ
              trực quan và bài tập thực hành.
            </p>
            <Link
              href={languages[0] ? `/learn/${languages[0].id}` : "/learn"}
              passHref
            >
              <Button
                size="lg"
                className="mt-4 shadow-lg hover:shadow-xl transition-shadow bg-primary text-white hover:bg-primary/90"
              >
                Khám phá Khóa học Đầu tiên
          ...
          <div className="bg-secondary/20 dark:bg-secondary/30 p-6 rounded-lg border border-secondary shadow-md mt-12">
            ...
            <p className="mt-2 text-secondary-foreground/80">
              Bạn đang ở bài 02: Văn bản và định dạng của khóa HTML. Hãy tiếp tục học để hoàn thành
              mục tiêu.
            </p>
